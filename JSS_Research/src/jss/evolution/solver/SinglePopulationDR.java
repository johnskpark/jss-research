 ...
 * TODO javadoc.
 *
 * This needs to be modified so that the priority that is being read in is the one that I have in my mind.
 * @author parkjohn
 *
 */
public class SinglePopulationDR extends JSSGPRule {
	 ...
	 * @param tracker
	 */
	public SinglePopulationDR(EvolutionState state,
			GPIndividual[] inds,
			int threadnum,
			JSSGPData data,
			ITracker tracker) {
