...
public class HaDMOEA2MultiObjectiveFitness extends MultiObjectiveFitness
    {
    ...
    public boolean equivalentTo(Fitness _fitness)
        {
        HaDMOEA2MultiObjectiveFitness other = (HaDMOEA2MultiObjectiveFitness) _fitness;
        return (rank == ((HaDMOEA2MultiObjectiveFitness) _fitness).rank) &&
    ...
    public boolean betterThan(Fitness _fitness)
        ...
        if (rank < ((HaDMOEA2MultiObjectiveFitness) _fitness).rank)
            return true;
        else if (rank > ((HaDMOEA2MultiObjectiveFitness) _fitness).rank)
            return false;
