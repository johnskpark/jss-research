...
public class GPjspPriority extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspPriority newobj = (GPjspPriority) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspPriority.class.getName()).log(Level.SEVERE, null, ex);
