...
public class GPjspGP3 extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspGP3 newobj = (GPjspGP3) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspGP3.class.getName()).log(Level.SEVERE, null, ex);
