...
public class GPjspMix extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspMix newobj = (GPjspMix) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspMix.class.getName()).log(Level.SEVERE, null, ex);
        ...
        final int threadnum)
    {
        if (!ind.evaluated)  // don't bother reevaluating
            ...
            //f.setStandardizedFitness(state,(float)(jspTrainning[0].getCmax()));
        ...
        public void finishEvaluating(final EvolutionState state, final int threadnum)
        {
            if (state.generation == state.numGenerations-1) {
                ...
                f.results+= "\n" + getTestPerformance(state, threadnum, best_i, 1, 105);   //la
            }
        }
        private String getTestPerformance(final EvolutionState state, final int threadnum, Individual best_i, int startIndex, int nInstances){
                ...
                double[] twt = new double[nInstances];
                ...
                //start evaluate schedule
                    ...
                    twt[instance] = jspTesting[instance].getTotalWeightedTardiness();
                }
