...
public class GPjspDDA extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspDDA newobj = (GPjspDDA) (super.clone());
                ...
                for (int ds = 0; ds < 1; ds++) {
                    ...
                    while (!jspDynamic.isStop()) {
                        if (jspDynamic.isNextArrivalEvent()) {
                            ...
                            double flow = input.tempVal;
                            if (flow < 0.0 || flow
                                    == Double.POSITIVE_INFINITY || Double.isNaN(flow)){
