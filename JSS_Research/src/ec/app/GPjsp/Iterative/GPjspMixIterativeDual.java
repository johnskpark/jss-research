...
public class GPjspMixIterativeDual extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspMixIterativeDual newobj = (GPjspMixIterativeDual) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspMixIterativeDual.class.getName()).log(Level.SEVERE, null, ex);
