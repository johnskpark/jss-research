...
public class GPjspPriorityIterativePseudo extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspPriorityIterativePseudo newobj = (GPjspPriorityIterativePseudo) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspPriorityIterativePseudo.class.getName()).log(Level.SEVERE, null, ex);
