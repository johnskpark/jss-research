...
public class GPjspPriorityIterativeVNSLookahead extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspPriorityIterativeVNSLookahead newobj = (GPjspPriorityIterativeVNSLookahead) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspPriorityIterativeVNSLookahead.class.getName()).log(Level.SEVERE, null, ex);
            ...
            for (int instance = 0; instance < jspTrainning.length; instance++){
                ...
                do {
                    ...
                    while (nScheduledOp<N){
                        ...
                        jspTrainning[instance].setNonDelayFactor(input.tempVal);
                        //end non-delay factor selection

                        // determine priority of jobs in queue
                        jspTrainning[instance].setInitalPriority(M);
                        ((GPIndividual)ind).trees[Nk+1].child.eval(
                            state,threadnum,input,stack,((GPIndividual)ind),this);
                ...
                for (int instance = 0; instance < jspTrainning.length; instance++){
                    ...
                    do {
                        ...
                        while (nScheduledOp<N){
                            ...
                            // determine priority of jobs in queue
                            jspTrainning[instance].setInitalPriority(M);
                            ((GPIndividual)best_i).trees[Nk+1].child.eval(
                                state,threadnum,input,stack,((GPIndividual)best_i),this);
                            for (Job J:M.getQueue()) {
                                J.addPriority(J.tempPriority);
                            }
