...
public class GPjspMixIterativeVNS extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspMixIterativeVNS newobj = (GPjspMixIterativeVNS) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspMixIterativeVNS.class.getName()).log(Level.SEVERE, null, ex);
