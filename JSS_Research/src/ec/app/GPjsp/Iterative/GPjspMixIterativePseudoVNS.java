...
public class GPjspMixIterativePseudoVNS extends GPProblem implements SimpleProblemForm {
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspMixIterativePseudoVNS.class.getName()).log(Level.SEVERE, null, ex);
