...
public class GPjspPriorityIterative extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspPriorityIterative newobj = (GPjspPriorityIterative) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspPriorityIterative.class.getName()).log(Level.SEVERE, null, ex);
