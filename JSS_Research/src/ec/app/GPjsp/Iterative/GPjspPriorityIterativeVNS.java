...
public class GPjspPriorityIterativeVNS extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspPriorityIterativeVNS newobj = (GPjspPriorityIterativeVNS) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspPriorityIterativeVNS.class.getName()).log(Level.SEVERE, null, ex);
