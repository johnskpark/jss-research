...
public class GPjspPriorityIterativeDual extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspPriorityIterativeDual newobj = (GPjspPriorityIterativeDual) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspPriorityIterativeDual.class.getName()).log(Level.SEVERE, null, ex);
            ...
            for (int instance = 0; instance < jspTrainning.length; instance++){
                ...
                do {
                    ...
                    while (nScheduledOp<N){
                        ...
                        ((GPIndividual)ind).trees[dr].child.eval(
                ...
                for (int instance = 0; instance < jspTesting.length; instance++){
                    ...
                    do {
                        ...
                        while (nScheduledOp<N){
                            ...
                            // determine priority of jobs in queue
                            jspTrainning[instance].setInitalPriority(M);
                            ((GPIndividual)best_i).trees[dr].child.eval(
