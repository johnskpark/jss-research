...
public class GPjspMixIterativePseudo extends GPProblem implements SimpleProblemForm {
    ...
    public Object clone(){
        GPjspMixIterativePseudo newobj = (GPjspMixIterativePseudo) (super.clone());
    ...
    public void setup(final EvolutionState state,final Parameter base) {
        ...
        super.setup(state,base);
                ...
                try {
                    ...
                    Logger.getLogger(GPjspMixIterativePseudo.class.getName()).log(Level.SEVERE, null, ex);
