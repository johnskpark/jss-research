...
public class QCSP {
    ...
    public static void main(String[] args) throws IOException {
        ...
        QCSP[][] test = new QCSP[nSet][nInPerSet];
        ...
        for (int i = 0; i < nSet; i++) {
            for (int j = 0; j < test[i].length; j++) {
                test[i][j] = new QCSP(QCSP.dataset[i+fromT] + df2.format(j + fromInstanceT + 1) + ".txt");
        ...
        writeResult("nqcspREPORT" + QCSP.uncertainty + outname, report + "\n === robust test === \n" + testReport, false);
        System.out.println("\n === robust test === \n" + testReport);
    ...
    public QCSP(String problemfile) throws IOException{
