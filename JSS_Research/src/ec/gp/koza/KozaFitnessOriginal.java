...
public class KozaFitnessOriginal extends Fitness
    {
    ...
    */
    ...
    public final double adjustedFitness()
        {
        return fitness();
        }
    ...
    public boolean betterThan(final Fitness _fitness)
        ...
        return _fitness.fitness() > fitness();
        /*
        KozaFitness K = (KozaFitness)_fitness;
        if (K.max==max){
            return K.average>average;
        }
        return K.max>max;
         //*/
    ...
    public String fitnessToStringForHumans()
        {
        return FITNESS_PREAMBLE + "Standardized=" + standardizedFitness +
                " Adjusted=" + adjustedFitness()
                + " Min=" + min
                + " Average=" + average
                + " Max=" + max
                + " Hits=" + hits + "\n" + results;
    ...
    public void setToMeanOf(EvolutionState state, Fitness[] fitnesses)
        ...
        for(int i = 0; i < fitnesses.length; i++)
            {
            KozaFitnessOriginal fit = (KozaFitnessOriginal)(fitnesses[i]);
