                ...
                for (int ds = 0; ds < rep; ds++) {
                    ...
                    if (jspDynamic.isNextArrivalEvent()) {
                        ...
                        for (int i = 0; i < newjob.getNumberOperations(); i++) {
                            ...
                            double EOTR = jspDynamic.getMachines()[mm].getSampledOTRatio(newjob.getKthOperationProcessingTime(i));
                            estimatedFlowTime+=OT+QWL+LOT;
                        }
                        //Dynamic DDAMs
                        double N = jspDynamic.getNumberofJobs();
                    ...
                    for (int j = 0; j < lowers.length; j++) {
                        for (int k = 0; k < numbeOfMachines.length; k++) {
                            for (int l = 0; l < utilisation.length; l++) {
                                for (int m = 0; m < rep; m++) {
                                    System.out.print(detailedTest[i][j][k][l][0][m]+",");
                                }
                                System.out.println("");
                            }
                        }
