 ...
 */
//expo miss 4 0.6 0.16340287348078722 -0.015513908224979299 0.21356994663969936 2.144299633686752 0.7211954458509418 1.2288209450621843 6.267943670293197 0.3639693868400629
package DDAMrules;
...
public class Journal_DynamicDDAM_ADDAM_bestFCFS {
    /**
    ...
    */
    public static void main(String[] args) throws FileNotFoundException, IOException, IllegalArgumentException {
        double[][][][][][] e1 = Journal_DynamicDDAM_ADDAM_bestFCFS.simDDAM(false,true,1);
        System.out.println("==============================================");
    }
            ...
            for (String dist : dists){for (String s : lowers){ for (int m : numbeOfMachines){ for (double u : utilisation){
                ...
                for (int ds = 0; ds < rep; ds++) {
                    ...
                    if (jspDynamic.isNextArrivalEvent()) {
                        ...
                        if (N-TLOT-TQWL>=0){
                            newjob.assignDuedate(TOT+TLOT+TQWL);
                        } else {
                            newjob.assignDuedate(TOT+TLOT*0.6615654+TQWL);
                        }
