...
public class DynamicDDAM_ODDAM_bestFCFS {
    /**
                ...
                for (int ds = 0; ds < rep; ds++) {
                    ...
                    if (jspDynamic.isNextArrivalEvent()) {
                        ...
                        for (int i = 0; i < newjob.getNumberOperations(); i++) {
                            ...
                            if (div(LOT,LOT)-QWL-LOT+SAPR-PEF+SAPR-PEF+OT+QWL+LOT>=0){
                                if (LOT-PEF-PEF+LOT>=0){
                                    tempt=OT+QWL+LOT;
                                } else{
                                    tempt=QWL+OT;
                                }
                            } else{
                                if (div(RWL-QWL-QWL-LOT+SAPR-QWL-LOT,LOT)-QWL-LOT+SAPR>=0){
                                    tempt=OT+OTR+QWL+LOT;
                                } else{
                                    tempt=LOT+QWL+OT-div(LOT,LOT);
                                }
                                tempt = tempt - OTR;
                            }
