...
public class JasimaGroupedProblem extends GPProblem implements IJasimaGPProblem {
	...
	private IJasimaEnsembleTracker tracker;
	...
	public void setup(final EvolutionState state, final Parameter base) {
		...
		// Setup the tracker.
		tracker = (IJasimaEnsembleTracker) state.parameters.getInstanceForParameterEq(base.push(P_TRACKER), null, IJasimaEnsembleTracker.class);
