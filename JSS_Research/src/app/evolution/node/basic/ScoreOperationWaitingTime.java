...
public class ScoreOperationWaitingTime extends SingleLineGPNode {
	...
	public void eval(final EvolutionState state,
		...
		data.setPriority(data.getPrioRuleTarget().getShop().simTime() - data.getPrioRuleTarget().getArriveTime());
	}
