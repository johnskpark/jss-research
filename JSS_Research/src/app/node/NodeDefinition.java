...
public enum NodeDefinition {
	...
	SCORE_AVERAGE_BREAKDOWN_TIME_ALL_MACHINES("AABT", 0, NodeType.MACHINE),
	SCORE_AVERAGE_BREAKDOWN_TIME_NEXT_MACHINE("NABT", 0, NodeType.MACHINE),
	SCORE_PREVIOUS_BREAKDOWN_TIME_NEXT_MACHINE("NPBT", 0, NodeType.MACHINE),
	SCORE_AVERAGE_BREAKDOWN_TIME("ABT", 0, NodeType.MACHINE),
	SCORE_PREVIOUS_BREAKDOWN_TIME("PBT", 0, NodeType.MACHINE),

	SCORE_AVERAGE_REPAIR_TIME_ALL_MACHINES("AART", 0, NodeType.MACHINE),
	SCORE_AVERAGE_REPAIR_TIME_NEXT_MACHINE("NART", 0, NodeType.MACHINE),
	SCORE_PREVIOUS_REPAIR_TIME_NEXT_MACHINE("NPRT", 0, NodeType.MACHINE),
	SCORE_AVERAGE_REPAIR_TIME("ART", 0, NodeType.MACHINE),
	SCORE_PREVIOUS_REPAIR_TIME("PRT", 0, NodeType.MACHINE),

	SCORE_AVERAGE_UP_TIME_ALL_MACHINES("AAUT", 0, NodeType.MACHINE),
	SCORE_AVERAGE_UP_TIME_NEXT_MACHINE("NAUT", 0, NodeType.MACHINE),
	SCORE_PREVIOUS_UP_TIME_NEXT_MACHINE("NPUT", 0, NodeType.MACHINE),
	SCORE_AVERAGE_UP_TIME("AUT", 0, NodeType.MACHINE),
	SCORE_PREVIOUS_UP_TIME("PUT", 0, NodeType.MACHINE);
