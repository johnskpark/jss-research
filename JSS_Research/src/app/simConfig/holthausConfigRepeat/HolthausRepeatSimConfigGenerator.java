...
public class HolthausRepeatSimConfigGenerator {
	...
	private HolthausRepeatSimConfigGenerator() {
	}
	...
	public static final DynamicBreakdownSimConfig getSimConfig(String instances) {
		...
		return new HolthausRepeatSimConfig(repairTimeFactors, breakdownLevels, dueDateFactors, repeat);
	}
