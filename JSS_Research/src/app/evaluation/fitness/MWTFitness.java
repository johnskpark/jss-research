...
public class MWTFitness implements IJasimaEvalFitness {
	...
	public double getNumericResult(final TrackedRuleBase<INode> rule,
			...
			final JobShopExperiment experiment,
			final JasimaExperimentTracker<INode> tracker) {
		return WeightedTardinessStat.getMeanWeightedTardiness(experiment.getResults());
	}
	...
	public String getStringResult(final TrackedRuleBase<INode> rule,
			...
			final JobShopExperiment experiment,
			final JasimaExperimentTracker<INode> tracker) {
		return String.format("%f", WeightedTardinessStat.getMeanWeightedTardiness(experiment.getResults()));
	}
